...
// Modified version of highlight.js v9.5.0, which is available under a BSD
// 3-Clause License (see git.io/hljslicense)
(function(factory) {
  ...
  return {
    ...
    keywords: {
      ...
      built_in:
        ...
        'KeyboardInterrupt LookupError MemoryError NameError NotADirectoryError NotImplemented ' +
