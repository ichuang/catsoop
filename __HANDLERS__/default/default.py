...
def handle_submit(context):
    ...
    for name in names:
        ...
        out['message'] = '<div class="bs-callout bs-callout-default" id="cs_partialresults_%s"><span id="cs_partialresults_%s_message">Your submission (id <code>%s</code>) has been received and queued for testing.  Watch here for updates.</span><br/><center><img src="data:image/gif;base64,"/></div>\n' % (name, name, entry_id)
