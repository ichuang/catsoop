...
* First, you can either download the extension from <https://catsoop.org/_static/catsoop-syntax-0.0.1.vsix> or build it yourself by running the following commands from this directory:
    ```
...
* Then you can install the extension in any of three different ways:
    * By running `$ code --install-extension catsoop-syntax-0.0.1.vsix`, or
