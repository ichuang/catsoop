...
class ValueRangeConstraint(AbstractConstraint):
    ...
    to :class:`~..type.univ.Integer` and
    :class:`~..type.univ.Real` types.
...
class ValueSizeConstraint(ValueRangeConstraint):
    ...
    to :class:`~..type.univ.BitString`,
    :class:`~..type.univ.OctetString` (including
    all :ref:`character ASN.1 types <type.char>`),
    :class:`~..type.univ.SequenceOf`
    and :class:`~..type.univ.SetOf` types.
    ...
    (e.g. :class:`~..type.univ.SequenceOf`,
    :class:`~..type.univ.SetOf`), constraint
