...
class Asn1ItemBase(Asn1Item):
    #: Set or return a :py:class:`~..type.tag.TagSet` object representing
    ...
    @property
    def tagMap(self):
        """Return a :class:`~..type.tagmap.TagMap` object mapping ASN.1 tags to ASN.1 objects within callee object.
        """
    ...
    def isSameTypeWith(self, other, matchTags=True, matchConstraints=True):
        ...
        ASN.1 tags (:py:mod:`~..type.tag`) and constraints
        (:py:mod:`~..type.constraint`) are examined when carrying
...
class AbstractSimpleAsn1Item(Asn1ItemBase):
    ...
    def subtype(self, value=noValue, **kwargs):
        ...
        by its tag(s) (:py:class:`~..type.tag.TagSet`) and value range
        constraints (:py:class:`~..type.constraint.ConstraintsIntersection`).
        ...
        Other Parameters
        ----------------
        implicitTag: :py:class:`~..type.tag.Tag`
            Implicitly apply given ASN.1 tag object to `self`'s
            :py:class:`~..type.tag.TagSet`, then use the result as
            new object's ASN.1 tag(s).

        explicitTag: :py:class:`~..type.tag.Tag`
