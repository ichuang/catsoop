...
class TagSet(object):
    ...
    Represents a combination of :class:`~..type.tag.Tag` objects
    ...
    *TagSet* objects are immutable and duck-type Python :class:`tuple` objects
    holding arbitrary number of :class:`~..type.tag.Tag` objects.

    Parameters
    ----------
    baseTag: :class:`~..type.tag.Tag`
        Base *Tag* object. This tag survives IMPLICIT tagging.

    *superTags: :class:`~..type.tag.Tag`
    ...
    def superTags(self):
        ...
        -------
        : :py:class:`tuple`
            Tuple of :class:`~..type.tag.Tag` objects that this *TagSet* contains
        """
    ...
    def tagExplicitly(self, superTag):
        ...
        Parameters
        ----------
        superTag: :class:`~..type.tag.Tag`
            *Tag* object to tag this *TagSet*

        Returns
        -------
        : :class:`~..type.tag.TagSet`
            New *TagSet* object
        """
