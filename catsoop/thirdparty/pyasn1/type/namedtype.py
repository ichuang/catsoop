...
class NamedTypes(object):
    ...
    *NamedTypes* objects are immutable and duck-type Python :class:`dict` objects
    ...
    Parameters
    ----------
    *namedTypes: :class:`~..type.namedtype.NamedType`
    ...
    def tagMap(self):
        ...
        Return a :class:`~..type.tagmap.TagMap` object by
