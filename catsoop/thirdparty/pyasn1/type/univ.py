...
# License: http://snmplabs.com/../license.html
#
import math
import sys
...
class Integer(base.AbstractSimpleAsn1Item):
    ...
    tagSet: :py:class:`~..type.tag.TagSet`
        Object representing non-default ASN.1 tag(s)

    subtypeSpec: :py:class:`~..type.constraint.ConstraintsIntersection`
        Object representing non-default ASN.1 subtype constraint(s)

    namedValues: :py:class:`~..type.namedval.NamedValues`
        Object representing non-default symbolic aliases for numbers

    Raises
    ------
    :py:class:`~..error.PyAsn1Error`
    ...
    #: :py:class:`~..type.tag.TagSet` object representing ASN.1 tag(s)
    ...
    #: Set (on class, not on instance) or return a
    #: :py:class:`~..type.constraint.ConstraintsIntersection` object
    #: imposing constraints on |ASN.1| type initialization values.
    subtypeSpec = constraint.ConstraintsIntersection()

    #: Default :py:class:`~..type.namedval.NamedValues` object
...
class Null(OctetString):
    ...
    Keyword Args
    ------------
    value: :class:`str` or :py:class:`~..type.univ.Null` object
...
class SequenceOfAndSetOfBase(base.AbstractConstructedAsn1Item):
    ...
    Keyword Args
    ------------
    componentType : :py:class:`~..type.base.PyAsn1Item` derivative
        A .. object representing ASN.1 type allowed within |ASN.1| type
    ...
    sizeSpec: :py:class:`~..type.constraint.ConstraintsIntersection`
    ...
    def setComponentByPosition(self, idx, value=noValue,
        ...
        Keyword Args
        ------------
        value: :class:`object` or :py:class:`~..type.base.PyAsn1Item` derivative
...
class SequenceOf(SequenceOfAndSetOfBase):
    ...
    #: Default :py:class:`~..type.base.PyAsn1Item` derivative
    ...
    #: Default :py:class:`~..type.constraint.ConstraintsIntersection`
...
class SequenceAndSetBase(base.AbstractConstructedAsn1Item):
    ...
    Keyword Args
    ------------
    componentType: :py:class:`~..type.namedtype.NamedType`
    ...
    """
    #: Default :py:class:`~..type.namedtype.NamedTypes`
...
class Sequence(SequenceAndSetBase):
    ...
    #: Default collection of ASN.1 types of component (e.g. :py:class:`~..type.namedtype.NamedType`)
    #: object imposing size constraint on |ASN.1| objects
    componentType = namedtype.NamedTypes()
...
class Choice(Set):
    ...
    def effectiveTagSet(self):
        """Return a :class:`~..type.tag.TagSet` object of the currently initialized component or self (if |ASN.1| is tagged)."""
        if self.tagSet:
            return self.tagSet
        else:
            component = self.getComponent()
    ...
    @property
    def tagMap(self):
        """"Return a :class:`~..type.tagmap.TagMap` object mapping
