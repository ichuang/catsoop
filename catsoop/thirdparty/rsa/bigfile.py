...
def encrypt_bigfile(infile, outfile, pub_key):
    ...
    :param pub_key: :py:class:`.PublicKey` to encrypt with

    """

    warnings.warn("The '.bigfile.encrypt_bigfile' function was deprecated in Python-RSA version "
...
def decrypt_bigfile(infile, outfile, priv_key):
    ...
    :param priv_key: :py:class:`.PrivateKey` to decrypt with

    """

    warnings.warn("The '.bigfile.decrypt_bigfile' function was deprecated in Python-RSA version "
                  "3.4 due to security issues in the VARBLOCK format. See "
                  "https://stuvel.eu/python-rsa-doc/usage.html#working-with-big-files "
                  "for more information.",
                  DeprecationWarning, stacklevel=2)
